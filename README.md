...
passwordValidator | <sub>`FormFieldValidator<String>`</sub>     | <sub>Same as `userValidator` but for password during registration</sub>
loginPasswordValidator | <sub>`FormFieldValidator<String>`</sub>     | <sub>Can be used to override the `passwordValidator` in login mode</sub>
